...
class DescriptionShopViewController: UIViewController, UIScrollViewDelegate {
    ...
    func createSlides() -> [DescriptionShopSlide] {
        ...
        slide1.imageView.image = UIImage(named: "chat")
        slide1.TitleLabelField.text = "Mise en relation avec des influenceurs"
        slide1.DescriptionLabelField.text = "Créez des relations avec des influenceurss pour de futurs partenariats"
        ...
        slide2.imageView.image = UIImage(named: "delivery")
        ...
        slide3.imageView.image = UIImage(named: "queue")
